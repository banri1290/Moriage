...
public class ControllerManager : GameSystem
{
    ...
    [SerializeField] private float controllerScale = 1f;
    ...
    public override bool CheckSettings()
    {
        ...
        if (player == null)
        {
            Debug.LogError("PlayerCtrl is null");
            result = false;
        }
        ...
        {
            Debug.LogError("ControlButton is null");
            result = false;
        }

        if (canvasRect == null)
        {
            Debug.LogError("CanvasRect is null");
            result = false;
        }
    ...
    public void Init()
    {
        ...
        if (controlButton != null)
        {
            ...
            buttonRect.localScale = Vector3.one * controllerScale;
        }
        SetPosition();
    }
